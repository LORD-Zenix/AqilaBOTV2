...
const nyoutube = ('NoxyBotz © 𝑁𝑎𝑛𝑑𝑎𝐷𝑒𝑣 2022')  //ubah di config biar ngk emror
const foter = ('NoxyBotz © 𝑁𝑎𝑛𝑑𝑎𝐷𝑒𝑣 2022')
...
const sendStickerFromUrl = async(to, url) => {
      ...
      //Resize
         const reSize = async(buffer, ukur1, ukur2) => {
             ...
             //Fake
	    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2009,status: 200, thumbnail: await reSize(thumb, 100, 100), surface: 200, message: `${ytname}`, orderTitle: '𝑁𝑎𝑛𝑑𝑎𝐷𝑒𝑣', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
memey =`٬࿊⃟☃ MAKASIH KAK YANG UDAH SEWABOT SEMOGA LANCAR REZEKINYA JANGAN LUPA DONASI KAK ☕`
  but = [
        ...
        await naze.sendMessage(m.chat, { caption: `${swenya}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: but, footer: memey, quoted: ftroli})
             }
            break
            case 'sc': {
                m.reply('https://wa.me/6285701863281')
            }
            break		 
            case 'subsyt': {
  ...
  naze.sendMessage(m.chat, buttonMessage, {quoted: ftroli})
            	}
            break
            ...
            break
            case 'polling':{
                if (!m.isGroup) return m.reply('Fitur Khusus Di Dalam Group!')
                if (args.length < 1) return m.reply(`Kirim Perintah ${command} caption >Polling <Polling`);
                if (!q.includes(">")) return m.reply(`Format Salah, Contoh Kirim Perintah ${command} caption >Polling <Polling`);  
                if (!q.includes("<")) return m.reply(`Format Salah, Contoh Kirim Perintah ${command} caption >Polling <Polling`);  
                var q = args.join(" ") 
                var B = q.split(">")
                var C = q.split("<")
...
break
	...
	case 'menfes': case 'menfess': {
            ...
            await naze.sendMessage(m1 + '@s.whatsapp.net', { caption: pjtxt, location: { jpegThumbnail: await reSize(ivg, 300, 200)}, buttons, footer: `Ciee ada yang ngirim pesan nih\n© 𝑁𝑎𝑛𝑑𝑎𝐷𝑒𝑣`}, {quoted: ftroli})
            let akhji = `Pesan Telah Terkirim\nKe @${mq1.split('@')[0]}`
            await naze.sendButtonText(m.chat, but, akhji, nyoutube, m, {mentions: ments})
            }
            break
        case 'menfesconfirm': {
 				naze.sendMessage(q, {text: `Sudah Di Confirmasi Nih Menfess nyaa🤭`})
				 m.reply(`Terimakasih Menfess Telah Diterima.`)
				}
               break
case 'chatwith2': {
if (m.isGroup) return m.reply('Fitur Tidak Dapat Digunakan Di Dalam Group!')
naze.sendMessage(q+'@s.whatsapp.net', {text: `Sudah Di Confirmasi Nih Menfess nyaa ntar lagi dia balas🤭`})
...
await naze.sendMessage(roomA.b, {text:" Yah dia telah meninggalkan chat Menfes"})
await setTimeout(() => {
...
await naze.sendMessage(roomB.a,{text:`Partnermu telah meninggalkan room anonymous`})
...
┃ *冬 My Love: Gapunya◕◡◕*
┃ *冬 Email: nandananda2235@gmail.com*
 ...
 break
            ...
            let kukiw = `*Kak ${pushname} ${ucapanWaktu} Semoga Harimu Menyenangkan*`
	           ...
	           rows: [
                ...
                naze.sendListMsg(m.chat, kukiw, nyoutube, `*${ucapanWaktu}*`, `Touch Me (⁠≧⁠▽⁠≦⁠)`, sections, ftroli)
            }
            break
            case 'mgroup': {
goup = `╭──❍ *Group Menu*
...
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${goup}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
      case 'mwebzone': {
wbzone = `╭──❍ *Webzone Menu*
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${wbzone}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'mdownloader': {
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${dwnloader}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'msearch': {
sarch = `╭──❍ *Search Menu*
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${sarch}`, location: { jpegThumbnail: await reSize(faall, 300, 200)},  buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'mrandom': {
rndom = `╭──❍ *Random Menu*
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${rndom}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'mtextpro': {
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${txtpro}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'mphotooxy': {
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${potooxy}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'mephoto': {
ehoto = `╭──❍ *Ephoto Menu*
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${ehoto}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
           case 'mfun': {
mun = `╭──❍ *Fun Menu*
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${mun}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'mprimbon': {
pimbon = `╭──❍ *Primbon Menu*
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${pimbon}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'mconvert': {
cnvert = `╭──❍ *Convert Menu*
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${cnvert}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'mmain': {
min = `╭──❍ *Main Menu*
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${min}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'mdatabase': {
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${dtbase}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'manonymous': {
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${aonymous}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'mislamic': {
islmic = `╭──❍ *Islamic Menu*
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${islmic}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
case 'mvoice': {
vice = `╭──❍ *Voice Changer*
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${vice}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'mowner': {
oner = `╭──❍ *Owner Menu*
...
╰────❍`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            naze.sendMessage(m.chat, { caption: `${oner}`, location: { jpegThumbnail: await reSize(faall, 300, 200)}, buttons: buttons, nyoutube, quoted: ftroli})
            }
            break
            case 'allmenu': {
            let ownernya = ownernomer + '@s.whatsapp.net'
